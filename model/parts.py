...
class backbone_block(nn.Module):
    ...
    def __init__(self):
        ...
        for i in range(3):
            ...
            # 1Odd number divided by 2 is exactly 1, zero_pad is true
            zero_pad = i%2
...
class dense_block(nn.Module):
    ...
    def __init__(self):
        ...
        # according to the author, the input of linear1 need to be change manually when a different dataset is used
        # A Transfer-Based Framework for Underwater Target Detection from Hyperspectral Imagery, https://www.mdpi.com/2072-4292/15/4/1023
        dense.add_module('linear1', nn.Linear(2176, 512))   # simulated_data:1216  River scene:2176  Ningxiang: 2176
